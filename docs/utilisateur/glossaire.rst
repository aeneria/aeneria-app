...
.. glossary::
    ...
    Humidité
        ...
        * A 100%, l'air est saturé en eau
        ...
        .. seealso::
            `L'humidité relative sur Wikipédia <https://fr.wikipedia.org/wiki/Humidit%C3%A9_relative>`_

    kWH
        Kilowatt-heure est l'unité d'énergie généralement utilisée pour mesurer la consommation d'électricité.

        .. seealso::
            `le kWh sur Wikipédia <https://fr.wikipedia.org/wiki/Kilowatt-heure>`_
    ...
    Nebulosité
        ...
        * A 100% le ciel est complètement obstrué par des nuages
        ...
        .. seealso::
            `La nébulosité sur Wikipédia <https://fr.wikipedia.org/wiki/Nuage#N%C3%A9bulosit%C3%A9_et_opacit%C3%A9>`_
