<template>
  <div class="p-grid">
    <div id="topbar-mobile" class="p-col p-d-flex p-ai-center p-jc-between">
      <Button
        type="button"
      ...
      />
      <div class="logo p-d-flex p-ai-center p-mx-auto">
        <svg
          height="46px"
          width="auto"
    ...
    <Sidebar v-model:visible="displaySidebar">
      <SidebarMenu :isMobile="true"/>
      <div class="p-mt-auto">
        <Divider />
        <PlaceSelect/>
        <Divider />
        <MenuMonCompte :isMobile="true"/>
      </div>
    </Sidebar>
  </div>
</template>

<script lang="ts" src="./TopbarMobile.ts"/>
